...
const CACHE = "geii-lab-v7";
const SHELL = [
  "./", "./index.html", "./styles-v8.css", "./store-v5.jsx", "./icons.jsx", "./shared-fixed.jsx",
  "./logo.jsx", "./molecule-atom-v2.jsx", "./dashboard-v6.jsx", "./tasks.jsx", "./pomodoro-final.jsx",
